         ...
         <main className="flex-grow pt-28 md:pt-32">
            ...
            <section id="features" className="py-16 md:py-24 bg-white relative overflow-hidden">
               ...
               <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 auto-rows-[minmax(200px,auto)] md:auto-rows-[minmax(250px,auto)]">
                     ...
                     <div className="bg-white rounded-2xl md:rounded-3xl p-5 md:p-8 border border-slate-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_30px_-3px_rgba(0,0,0,0.12),0_4px_6px_-2px_rgba(0,0,0,0.05)] hover:-translate-y-1 transition-all duration-300 flex flex-row md:flex-col items-start gap-5 md:gap-0 h-full group">
                        <div className="w-12 h-12 bg-orange-50 rounded-xl flex items-center justify-center text-orange-500 shrink-0 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                     ...
                     <div className="bg-white rounded-2xl md:rounded-3xl p-5 md:p-8 border border-slate-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_30px_-3px_rgba(0,0,0,0.12),0_4px_6px_-2px_rgba(0,0,0,0.05)] hover:-translate-y-1 transition-all duration-300 flex flex-row md:flex-col items-start gap-5 md:gap-0 h-full group">
                        <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-blue-500 shrink-0 md:mb-6 group-hover:scale-110 transition-transform duration-300">
            ...
            <section id="testimonials" className="py-16 md:py-24 bg-slate-50">
               <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                     ...
                     <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-slate-100 transform md:scale-105 z-10 relative mt-4 md:mt-0">
                     ...
                     <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-slate-100 mt-4 md:mt-0">
                        <div className="flex gap-1 mb-4 text-gold-400">
                           {[1, 2, 3, 4, 5].map(i => <svg key={i} className="w-4 h-4 fill-current" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>)}
                        </div>
