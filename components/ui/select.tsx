  ...
  return (
    <div className={`relative ${className}`} ref={containerRef}>
      ...
      <div className="relative">
        ...
        {isOpen && (
          <div className="absolute z-50 mt-1 w-full bg-white rounded-lg shadow-xl border border-slate-100 max-h-60 overflow-auto animate-in fade-in zoom-in-95 duration-100 scrollbar-thin scrollbar-thumb-slate-200">
            <div className="p-1">
              {options.map((option) => {
                  ...
                  >
                    <div className="flex-1 flex items-center gap-2 text-left">
                        ...
                        <div>
                            ...
                            {option.description && <div className="text-[10px] text-slate-400 font-normal">{option.description}</div>}
                        </div>
                    </div>
                    {isSelected && (
